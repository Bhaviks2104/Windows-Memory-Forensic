...
#register in vtscanx tool and get the api key
VTSCANX_API_KEY = "vtscanx_4lriN8Crb4gi2c5FfGANLlBoCGRyEOD_ZDuCbpsw_dpD7XE7prdEVw"
...
def normalize_path(path):
    ...
    # Use raw strings and double backslashes properly
    ...
    # Fix drive root like "c:folder" -> "c:\folder"
